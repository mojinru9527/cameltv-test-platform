...
**最后更新**: 2026-09-14（Batch 240 AI/RAG Python 依赖分层；新增 C240-1）
...
| ID | 内容 | 优先级 | 创建日期 |
|----|------|--------|---------|
| C240-1 | 记录新 API/AI Gateway/Runner 实际镜像大小与共享层，验证 API image 体积下降 | P1 | 2026-09-14 |### batch-239 — 独立 AI Gateway 服务边界（2026-09-14）—— 新增
