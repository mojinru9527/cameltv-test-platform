...
**最后更新**: 2026-08-07 (Batch 118: 追踪器卫生审计 + C109-1 生产收尾 + C102-3/4 需求导入能力 + C117-1)
...
| ID | 内容 | 优先级 | 创建日期 |
|----|------|--------|---------|
| C104-3 | frontend/src/types/api.d.ts 用锁定版本 openapi-typescript 全量重生成，核对 28k 行漂移根因（工具版本差异），并将契约漂移纳入后续批次自检或 CI 校验 | P2 | 2026-08-06 |
...
| ID | 内容 | 优先级 | 创建日期 |
|----|------|--------|---------|
| C114-1 | 交互拓扑挂用例完整性核对（拓扑边 vs 交互用例覆盖矩阵，缺口自动提示） | P3 | 2026-08-07 |
