...
**最后更新**: 2026-08-08 (Batch 121: C120-1 全量拓扑 + C120-2 多 worker 验证)
...
| ID | 内容 | 优先级 | 创建日期 |
|----|------|--------|---------|
| C122-1 | 运营后台全量页面级深度用例（直播管理/消息/装扮/广告素材位/用户详情/风控白名单 等 14 模块逐页补齐） | P2 | 2026-08-08 |
| C122-2 | 全量接口用例深补（除预测/赔率外全部核心接口，真实请求体+字段断言） | P2 | 2026-08-08 |
| C122-3 | 生产环境导入 427 条 SP- 用例 + 生产侧验证（需 sportsadmin/TP_ADMIN_PASSWORD 凭据，部署时执行） | P1 | 2026-08-08 |
