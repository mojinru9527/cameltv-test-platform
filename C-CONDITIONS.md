...
| C68-4 | 正式域名发布决策登记到交付清单（本批演练已 200；域名启用/自定义域名决策由用户确认） | P1 | 2026-08-03（batch-72 决策材料已产出：A 保持 vercel.app（推荐）/ B 自定义域名 / C 仅内网；待用户确认启用） |
...
| ID | 内容 | 优先级 | 创建日期 |
|----|------|--------|---------|
| C72-1 | 正式域名发布决策（C68-4）三项确认后按选项 A/B 登记启用，关闭 C68-4 | P1 | 2026-08-04 |
| C72-2 | Playground 开放条件 = C22-C2/C3 实证（真实 Gherkin→步骤→执行→截图）；无实证维持 API-only | P2 | 2026-08-04 |
