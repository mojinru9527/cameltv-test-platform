...
class TestExecutionModelLink:
    ...
    def test_execute_all_creates_canonical_campaign(self, client, auth_headers, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            lambda db, **kwargs: (SimpleNamespace(id=88, status="running"), [SimpleNamespace(id=601)], 0),
        )
        ...
        assert resp.json()["data"]["campaign_id"] == 88
        assert resp.json()["data"]["run_ids"] == [601]
