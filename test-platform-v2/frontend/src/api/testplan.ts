...
export async function executeAllCases(planId: number, environmentId?: number, autoUi: boolean = true) {
  return api.post(`/test-plans/${planId}/execute-all`, { environment_id: environmentId || null, auto_ui: autoUi })
}
