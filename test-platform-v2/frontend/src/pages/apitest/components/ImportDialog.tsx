          ...
          {preview && (
            <div className="border rounded-lg p-4 space-y-3 bg-muted/30">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge className="bg-status-info-muted text-status-info">总计: {preview.total_count}</Badge>
                <Badge className="bg-status-success-muted text-status-success">新增: {preview.new_count}</Badge>
                {preview.existing_count > 0 && <Badge className="bg-status-warning-muted text-status-warning">已存在: {preview.existing_count}</Badge>}
              </div>
