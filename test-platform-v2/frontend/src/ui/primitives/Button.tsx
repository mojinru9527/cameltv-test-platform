  ...
  ({ className, variant = 'secondary', size = 'md', loading, disabled, type = 'button', children, ...props }, ref) => {
    return (
      <button
        ...
        type={type}
        className={cn(
          'ui-btn inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-colors outline-none select-none',
