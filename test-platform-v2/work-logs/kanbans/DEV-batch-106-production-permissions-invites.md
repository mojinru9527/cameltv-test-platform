...
| 2 | 组织权限映射（rbac + 测试） | ✅ | ✅ | ✅ | ✅ | ⏳ | 5 测试 |
| 3 | 项目邀请链接（模型/迁移/接口/注册集成 + 测试） | ✅ | ✅ | ✅ | ✅ | ⏳ | 9 测试 + 迁移 |
| 4 | 前端邀请链接 + 注册页参数 | ✅ | ✅ | ✅ | ✅ | ⏳ | vitest 352 全量绿 |
| 5 | 生产启用清单 + 演练证据 | ✅ | ✅ | ✅ | ✅ | ⏳ | checklist + evidence + env 模板 |
...
├── ✅ 组织权限映射：14 新测试 + 全量 1133 通过
├── ✅ 项目邀请链接：token 注册自动入项目/组织（HTTP 冒烟）
├── ✅ 生产启用：检查清单 + 演练证据 + env 模板（切换为 C106-1 人工步骤）
