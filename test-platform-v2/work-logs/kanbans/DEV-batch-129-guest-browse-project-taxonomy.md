...
| 1 | 访客模块说明与登录动作分离 | ✅ | ✅ | ✅ | ✅ | ⏳ | 26 个公开模块有静态说明；匿名业务 API=0 |
| 2 | 无项目布局边界与创建 CTA | ✅ | ✅ | ✅ | ✅ | ⏳ | Outlet 不挂载；业务请求=0 |
| 3 | 31 旧域后端重分类与 surface 契约 | ✅ | ✅ | ✅ | ✅ | ⏳ | 476 条全部归类，其他=0 |
| 4 | 脑图消费 surface 与动态筛选 | ✅ | ✅ | ✅ | ✅ | ⏳ | 无未知则不显示“其他” |
| 5 | QA / Network / 三视口 / Leader | ✅ | ✅ | ✅ | ✅ | ⏳ | 1270/434 + 三视口全绿 |
...
Batch 129
├─ ✅ Slice 0：工件与实现计划自检
├─ ✅ Slice 1：访客模块说明与显式登录动作
├─ ✅ Slice 2：无项目边界与创建项目引导
├─ ✅ Slice 3：31 个旧域/476 条用例重分类
├─ ✅ Slice 4：脑图统一消费后端 surface
