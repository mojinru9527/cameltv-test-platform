...
| 4 | Adapter contract | planned | pending | pending | pending | pending | after core |
...
## Current position
    ...
    Batch 62 -> Slice 3 -> local QA complete
    ...
    next: commit core, mandatory push-range confirmation, then adapter/API/UI consumer planning
