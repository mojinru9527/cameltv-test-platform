...
|---|-------|:----:|:----:|:----:|:----:|:----:|------|
| 0 | 环境与凭据核验（蓝湖 Cookie/OCR/SMTP 配置/启动） | ✅ | 🔄 | ⏳ | ⏳ | ⏳ | **当前位置** |
| 1 | C87-3 RBAC seed 矩阵修复（TDD） | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | PRD §4/Design §1 |
| 2 | C87-1 项目级蓝湖链接支持（TDD） | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | PRD §5/Design §3 |
| 3 | C87-1 真实证据包执行（Web/APP 链接 → OCR → 导入 RAG/Wiki） | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | |
| 4 | C87-2 SMTP 真实收发验证（plan_done + defect_assigned） | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | |
| 5 | 全项目 RBAC 核验矩阵 | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | |
| 6 | QA 硬门禁 + 回归 + 报告 | ⏳ | ⏳ | ⏳ | ⏳ | ⏳ | |
...
├── ✅ PRD + PM + Design + 看板
├── 🔄 Slice 0: 环境与凭据核验
├── ⏳ Slice 1: RBAC seed 矩阵修复（TDD）
├── ⏳ Slice 2: 项目级蓝湖链接支持（TDD）
├── ⏳ Slice 3: 真实证据包执行
├── ⏳ Slice 4: SMTP 真实收发
├── ⏳ Slice 5: 全项目 RBAC 核验
├── ⏳ Slice 6: QA 硬门禁
