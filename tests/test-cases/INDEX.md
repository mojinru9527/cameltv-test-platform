...
| 批次 | 用例文件 | P0 数 | P1 数 | P2 数 |
| --- | --- | --- | --- | --- |
| Batch 47 | [functional/BATCH47-测试平台需求服务-生产级验收.md](functional/BATCH47-测试平台需求服务-生产级验收.md) | 28 | 20 | 0 |
...
| 模块 | 功能/API/生产验收用例 |
| --- | --- |
| REQUIREMENT 需求服务 | [Batch 47 需求服务生产级验收](functional/BATCH47-测试平台需求服务-生产级验收.md) |
